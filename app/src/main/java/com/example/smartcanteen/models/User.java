...
public class User {
    ...
    public User(int id, String nom, String prenom, String numeroEtudiant, String email, String motDePasse) {
        this.id = id;
        this.nom = nom;
        this.prenom = prenom;
    ...
    public User(String nom, String prenom, String numeroEtudiant, String email, String motDePasse) {
        this.nom = nom;
        this.prenom = prenom;
        this.numeroEtudiant = numeroEtudiant;
        this.email = email;
